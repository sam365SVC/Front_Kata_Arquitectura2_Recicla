...
export const ESTADOS_INSPECCION = {
  asignada: {
    ...
    color: "#6366F1",        // indigo
    bg: "#EEF2FF",
    descripcion: "La inspección fue asignada al inspector pero aún no ha comenzado.",
  },
  en_inspeccion: {
    label: "pendiente",
    color: "#D97706",        // amber
    bg: "#FFFBEB",
    descripcion: "El inspector está realizando la revisión del equipo.",
  },
  completada: {
    label: "completada",
    color: "#059669",        // green
    bg: "#ECFDF5",
    descripcion: "La inspección fue finalizada y el resultado fue registrado.",
  },
  cancelada: {
    label: "Cancelada",
    color: "#DC2626",        // red
    bg: "#FEF2F2",
    descripcion: "La inspección fue cancelada.",
  },
};
